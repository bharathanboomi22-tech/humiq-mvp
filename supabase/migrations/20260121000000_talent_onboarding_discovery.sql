...
ADD COLUMN IF NOT EXISTS work_links JSONB DEFAULT '[]'; -- GitHub, portfolio, etc.
...
CREATE TABLE IF NOT EXISTS public.talent_test_results (
  ...
  test_type TEXT NOT NULL, -- e.g., 'backend', 'frontend', 'fullstack'
  scores_by_skill JSONB NOT NULL DEFAULT '{}', -- { "skill_name": score, ... }
...
CREATE TABLE IF NOT EXISTS public.interview_requests (
  ...
  message TEXT, -- Optional message from company
