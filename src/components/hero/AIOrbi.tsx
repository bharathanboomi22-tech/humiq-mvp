  ...
  return (
    <div className={`relative ${sizeClasses[size]}`}>
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255, 47, 178, 0.4) 0%, rgba(124, 58, 237, 0.2) 40%, transparent 70%)',
          filter: 'blur(8px)',
        }}
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 0 20px rgba(255, 47, 178, 0.5), inset 0 0 10px rgba(255, 255, 255, 0.3)',
        }}
        animate={shouldReduceMotion ? {} : {
