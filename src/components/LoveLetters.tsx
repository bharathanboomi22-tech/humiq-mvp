...
export function LoveLetters() {
  ...
  const [nameOrRole, setNameOrRole] = useState('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        name_or_role: nameOrRole.trim() || null,
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mb-4">
                A thought, a feeling, or a moment — short is perfect.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input
                  type="text"
                  value={nameOrRole}
                  onChange={(e) => setNameOrRole(e.target.value)}
                  placeholder="Founder, Engineer, Recruiter… (optional)"
            ...
            <AnimatePresence mode="popLayout">
              {letters.map((letter, index) => (
                ...
                >
                  ...
                  {/* Footer - Name/Role + User Type Badge */}
