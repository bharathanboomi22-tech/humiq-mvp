      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <div className="text-center mb-8">
            <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-pink-hot/10 text-pink-hot">
              For Candidates
            </span>
          </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <button
                      ...
                      className="font-medium text-pink-hot hover:underline"
                    >
